...
```bash
gh repo view peviitor-scrapers/electrogrup-sa-python-scraper --json repositoryTopics
```

## Cum setezi

```bash
gh repo edit peviitor-scrapers/electrogrup-sa-python-scraper --add-topic job-seeker-ro-spider --add-topic peviitor-ro
```

sau manual pe `https://github.com/peviitor-scrapers/electrogrup-sa-python-scraper/settings`.
