...
3. Verificare: `gh repo view peviitor-scrapers/electrogrup-sa-python-scraper --json defaultBranch`
...
gh api repos/peviitor-scrapers/electrogrup-sa-python-scraper/git/refs -f ref="refs/heads/main" -f sha=$(gh api repos/peviitor-scrapers/electrogrup-sa-python-scraper/git/refs/heads/master --jq '.object.sha')

# Schimbă default branch
gh api repos/peviitor-scrapers/electrogrup-sa-python-scraper -X PATCH -f default_branch="main"

# Șterge branch-ul master
gh api repos/peviitor-scrapers/electrogrup-sa-python-scraper/git/refs/heads/master -X DELETE
```
