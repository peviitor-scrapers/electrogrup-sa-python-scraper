...
Acest proiect folosește [GitHub Issues](https://github.com/peviitor-scrapers/electrogrup-sa-python-scraper/issues) pentru a urmări munca.
...
Vezi [toate issue-urile](https://github.com/peviitor-scrapers/electrogrup-sa-python-scraper/issues).
